    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        savebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                System.out.println("Inside Button click Statement");
                String item_details = "'"+itemid+"','" + itemname2 + "','" +itemcategory2 + "','" + quantity2 + "','" + itemdate +"','"+user+"','"+yearsused2+"'";


                System.out.println(item_details);

                new ReadWCFServiceFeed().execute("http://10.0.2.2:8871/Service1.svc/updateItemDetails/"+item_details);
