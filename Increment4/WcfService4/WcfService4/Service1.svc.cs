    ...
    public class Service1 : IService1
    {
        ...
        public String insertRegistrationDetails(String userdetails)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "INSERT REGISTRATION (FIRSTNAME,LASTNAME,USERNAME,PASSWORD,EMAILADDRESS,PHONENUMBER,ADDRESS,ZIPCODE,STATUS) VALUES (" + userdetails + ")";
        ...
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, UriTemplate = "retrieveUserDetails/{username}")]
        public userDetails retrieveUserDetails(String username)
        {
            ...
            try
            {
                SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["dbString"].ConnectionString);
                conn.Open();
                SqlCommand cmd1 = new SqlCommand("Select * From REGISTRATION WHERE USERNAME= '" + username + "'", conn);
                ...
                while (reader.Read())
                {
                    ...
                    user.mobilenumber = reader.GetDecimal(5);
                    user.address= reader.GetString(6);
                    user.zipcode = reader.GetDecimal(7);
                } reader.Close();
                conn.Close();
            }
            catch (Exception e)
        ...
        public String insertItemDetails(String itemDetails)
        {
           ...
           // insertJobDetails = insertJobDetails + ",sysdatetime(),sysdatetime(),'P'";
            ...
            try
            {
                ...
                cmd.CommandType = System.Data.CommandType.Text;
                cmd.CommandText = "INSERT ITEMS (ITEMNAME,ITEMCATEGORY,QUANTITY,DATECREATED,CREATEDBY,YEARSOFUSAGE,SUBSCRIBEDBY,APPROVEDBY) VALUES (" + itemDetails + ")";
        ...
        public String updateItemDetails(String itemDetails)
        {
            ...
            update_stmt = "Update ITEMS set ITEMNAME=" + newvals[1] + "," + 
                "ITEMCATEGORY=" + newvals[2] + ",QUANTITY=" + newvals[3] + ",YEARSOFUSAGE=" + newvals[6] + ",SUBSCRIBEDBY=" + newvals[7] + " where ITEMID = " + newvals[0];
        ...
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, UriTemplate = "updateItembyId/{subscribedetails}")]
        public String updateItembyId(String subscribedetails)
        {
            String str = "";
            String update_stmt = "";
            //String updateJobDetailsStmt = updateJobDetails;
            String[] newvals = new String[9];
            string[] words = subscribedetails.Split(',');
            for (int i = 0; i < words.Length; i++)
            {
                newvals[i] = words[i];
            }

            update_stmt = "Update ITEMS set SUBSCRIBEDBY=" + newvals[1] + " where ITEMID = " + newvals[0];
        ...
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, UriTemplate = "updateItemApprovalstatus/{approvaldetails}")]
        public String updateItemApprovalstatus(String approvaldetails)
        {
            String str = "";
            String update_stmt = "";
            //String updateJobDetailsStmt = updateJobDetails;
            String[] newvals = new String[9];
            string[] words = approvaldetails.Split(',');
            for (int i = 0; i < words.Length; i++)
            {
                newvals[i] = words[i];
            }

            update_stmt = "Update ITEMS set APPROVEDBY=" + newvals[1] + " where ITEMID = " + newvals[0];
        ...
        public List<itemDetail> extractItemDetails(String createduser)
        {
           ...
           // itemDetail detail = new itemDetail();
            var itemlist4 = new List<itemDetail>();
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    detail.subscribedby = reader.GetString(7);
                    itemlist4.Add(detail);
        ...
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, UriTemplate = "retrieveItemsbyCategory/{category}")]
        public List<itemDetail> retrieveItemsbyCategory(String category)
        {
            String str = "";
            ...
            try
            {
                ...
                SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["dbString"].ConnectionString);
                conn.Open();
                SqlCommand cmd1 = new SqlCommand("Select * From ITEMS where ITEMCATEGORY='" + category + "'", conn);
                SqlDataReader reader = cmd1.ExecuteReader();
                //String userName = ""; String pwd = ""; 
                while (reader.Read())
                {
        ...
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, UriTemplate = "retrieveItemsbySubsciption/{user}")]
        public List<itemDetail> retrieveItemsbySubsciption(String user)
        {
            String str = "";
            ...
            try
            {
                ...
                SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["dbString"].ConnectionString);
                conn.Open();
                SqlCommand cmd1 = new SqlCommand("Select * From ITEMS where SUBSCRIBEDBY='" + user + "'", conn);
                SqlDataReader reader = cmd1.ExecuteReader();
                //String userName = ""; String pwd = ""; 
                while (reader.Read())
                {
                    ...
                    detail.createdby = reader.GetString(5);
                    detail.subscribedby = reader.GetString(7);
                    detail.approvedby = reader.GetString(8);
                    itemlist.Add(detail);
