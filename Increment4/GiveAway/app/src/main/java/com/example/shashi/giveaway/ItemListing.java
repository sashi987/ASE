...
public class ItemListing extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ReadWCFServiceFeed().execute("http://10.0.2.2:8871/Service1.svc/Service1.svc/retrieveItemsbyCategory/"+"Electronics");
        System.out.println();
        //GetSearchResults();


        lv1 = (ListView) findViewById(R.id.listV_main2);
               ...
               // System.out.println("array length: " + n);
                ...
                // item_result = new ArrayList<>();
                   ...
                   // jsonobject = jsonarray.getJSONObject(i);
                    ...
                    item_details.setName("chair");
                    item_details.setItemid(jsonobject.getString("itemid"));
                    item_details.setitemcategory("Household");
                    item_details.setquantity("2");
                    ...
                    GiveAwayItemDetails item_details2 = new GiveAwayItemDetails();
                    item_details2.setName("chair");
                    item_details2.setItemid(jsonobject.getString("itemid"));
                    item_details2.setitemcategory("Household");
                    item_details2.setquantity("2");
                ...
                ArrayList<GiveAwayItemDetails> image_details = results;
                lv1.setAdapter(new ItemListBase2Adapter(ItemListing.this, image_details));
