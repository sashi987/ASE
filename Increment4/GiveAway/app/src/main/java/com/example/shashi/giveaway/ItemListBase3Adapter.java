...
public class ItemListBase3Adapter extends BaseAdapter {
    ...
    public ItemListBase3Adapter(Context context, ArrayList<GiveAwayItemDetails> results) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.txt_itemDescription.setText(itemDetailsrrayList.get(position).getitemcategory());
        holder.txt_itemPrice.setText(itemDetailsrrayList.get(position).getquantity());
