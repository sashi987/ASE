...
public class ItemListBase5Adapter extends BaseAdapter {
    ...
    public ItemListBase5Adapter(Context context, ArrayList<GiveAwayItemDetails> results) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.txt_itemDescription.setText("APPROVAL STATUS");
        holder.txt_itemPrice.setText(itemDetailsrrayList.get(position).getApprovedby());
