        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(userStudent.isChecked())
                    username2=username.substring(0,(username.length()-9));
                else if(userDonor.isChecked())
                ...
                if((username2.contains("gmail") && userDonor.isChecked())||(username.contains("umkc") && userStudent.isChecked()))
                { new ReadWCFServiceFeed().execute(
                       "http://kc-sce-cs551-3.kc.umkc.edu/aspnet_client/PG5/GiveAway/GiveAway/Service1.svc/userLoginDetails/"+username2);}
              else{
                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(LoginActivity.this);
                    alertDialog.setTitle("USER LOGIN FAILURE");
                    alertDialog.setMessage("ACCESS DENIED FOR ROLE.CHANGE ROLE TYPE");
        ...
        protected void onPostExecute(String result) {
            try {
                ...
                if(!(pwd).equals(jsonObject.getString("password"))){
                    ...
                    {home = new Intent(LoginActivity.this, Studentdashboard.class);
                        home.putExtra("username", username);
                        startActivity(home);}
                }
